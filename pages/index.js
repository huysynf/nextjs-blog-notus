                            ...
                            <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                                <div className="pr-12">
                                    <h1 className="text-white font-semibold text-5xl">
                                        Cho đi những gì đã nhận.
                                    </h1>
                                    <p className="mt-4 text-lg text-blueGray-200">
                                        Chia sẻ các kiến thức liên quan đến lập
                                        trình và cuộc sống
                                    </p>
                                </div>
                            </div>
                                ...
                                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                                    <div className="px-4 py-5 flex-auto">
                                        ...
                                        <p className="mt-2 mb-4 text-blueGray-500">
                                            Chi sẻ cách thức tôi đã đạt chứng
                                            chỉ hiện có trong 1 tháng nhưu thế
                                            nào
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="w-full md:w-4/12 px-4 text-center">
                                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                                    <div className="px-4 py-5 flex-auto">
                                        ...
                                        <p className="mt-2 mb-4 text-blueGray-500">
                                            Một số mẹo hay trong lập trình và
                                            trong cuộc sống
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="pt-6 w-full md:w-4/12 px-4 text-center">
                                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                                    <div className="px-4 py-5 flex-auto">
                                        ...
                                        <h6 className="text-xl font-semibold">
                                            Những chuyến hành trình tiếp theo
                                        </h6>
                                        <p className="mt-2 mb-4 text-blueGray-500">
                                            Đồng hành cùng các hành trình tiếp
                                            theo
                                        </p>
                                    </div>
                                </div>
